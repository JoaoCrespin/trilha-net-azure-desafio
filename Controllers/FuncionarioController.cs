...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        _context.SaveChanges(); //Chama o método SaveChanges do _context para salvar no Banco SQL
        ...
        tableClient.UpsertEntity(funcionarioLog); //Chama o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        _context.Funcionarios.Update(funcionarioBanco); //Chama o método de Update do _context.Funcionarios para salvar no Banco SQL
